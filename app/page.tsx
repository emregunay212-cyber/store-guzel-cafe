    ...
    <StoreShell store={store}>
      ...
      <section className="relative overflow-hidden">
        <div className="max-w-6xl mx-auto px-4 py-16 sm:py-24 text-center">
          ...
          <a href={`https://wa.me/905555555555`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-8 py-3.5 rounded-xl bg-green-600 hover:bg-green-700 text-white font-bold text-sm tracking-wide transition-colors">
      ...
      <section className="border-t border-[var(--color-border)] py-12">
        <div className="max-w-4xl mx-auto px-4 grid grid-cols-2 sm:grid-cols-4 gap-6">
          <div className="text-center">
              ...
              <div className="font-semibold text-sm">Taze Malzeme</div>
              <div className="text-xs text-[var(--color-muted)]">Her gün taze</div>
            </div>
            <div className="text-center">
              <div className="text-2xl mb-2">🚴</div>
              <div className="font-semibold text-sm">Hızlı Teslimat</div>
              <div className="text-xs text-[var(--color-muted)]">30 dakikada kapında</div>
            </div>
            <div className="text-center">
              <div className="text-2xl mb-2">🧑‍🍳</div>
              <div className="font-semibold text-sm">Şef Yapımı</div>
              <div className="text-xs text-[var(--color-muted)]">Profesyonel mutfak</div>
            </div>
            <div className="text-center">
              <div className="text-2xl mb-2">📱</div>
              <div className="font-semibold text-sm">Online Sipariş</div>
              <div className="text-xs text-[var(--color-muted)]">Kolay ve hızlı</div>
            </div>
        </div>
      </section>
    </StoreShell>
